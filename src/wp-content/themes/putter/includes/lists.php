...
if ( ! function_exists( 'putter_get_list_header_positions' ) ) {
	...
	function putter_get_list_header_positions( $prepend_inherit = false ) {
		$list = apply_filters( 'putter_filter_list_header_positions', array(
			'default' => esc_html__( 'Default', 'putter' ),
...
if ( ! function_exists( 'putter_get_list_body_styles' ) ) {
	...
	function putter_get_list_body_styles( $prepend_inherit = false, $force_fullscreen = false ) {
		...
		if ( apply_filters( 'putter_filter_allow_fullscreen', $force_fullscreen || putter_get_theme_setting( 'allow_fullscreen' ) || putter_get_edited_post_type() == 'page' ) ) {
			if ( putter_get_theme_setting( 'allow_fullwide', true ) ) {
				$list['fullwide']   = array(
...
if ( ! function_exists( 'putter_get_list_pages' ) ) {
	/**
	 ...
	 */
	function putter_get_list_pages( $prepend_inherit = false, $opt = array() ) {
		...
		return putter_get_list_posts( $prepend_inherit, $opt );
	}
}
