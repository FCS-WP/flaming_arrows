 ...
 */
class Putter_Elementor_Control_Choice extends \Elementor\Base_Data_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'putter-elementor-choice-control', putter_get_file_url( 'plugins/elementor/params/choice/choice-control.js'), array('jquery'), null, true );
	}
						...
						_.each( data.options, function( params, slug ) {
							print( ( params.new_row !== undefined
									...
									+ '<span tabindex="0" class="putter_list_choice_item'
												+ ( ( slug == data.controlValue && '' !== data.controlValue ) || ( 'inherit' == slug && '' === data.controlValue ) ? ' putter_list_active' : '' )
												+ '"'
										+ ' data-choice="' + slug + '"'
