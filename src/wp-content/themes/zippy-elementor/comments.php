	...
	$putter_show_comments     = putter_get_value_gp( 'show_comments' ) == 1
									|| ( ! $putter_full_post_loading
											...
											( 'scroll' != $putter_posts_navigation
												|| putter_get_theme_option( 'posts_navigation_scroll_hide_comments', 1 ) == 0
												|| putter_check_url( '#comments' )
											)
										);
	$putter_show_button       = ! $putter_show_comments || (int)putter_get_theme_option( 'show_comments_button', 0 ) == 1;
	$putter_open_comments     = putter_get_value_gp( 'show_comments' ) == 1
									|| ! $putter_show_button
									|| putter_get_theme_option( 'show_comments', 'hidden' ) == 'visible'
									|| putter_check_url( '#comments' );
		...
		<section class="comments_wrap<?php if ( $putter_open_comments ) { echo ' opened'; } ?>">
			...
			if ( comments_open() ) {
				...
				<div class="comments_form_wrap">
					...
					<?php
					$putter_form_style = esc_attr( putter_get_theme_option( 'input_hover', 'default' ) );
